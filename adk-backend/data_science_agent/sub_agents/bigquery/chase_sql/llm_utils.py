...
class GeminiModel:
    ...
    def __init__(
        self,
        model_name: str = os.getenv("CHASE_NL2SQL_MODEL", "gemini-2.0-flash-001"),
        ...
        **kwargs,
        ...
        Args:
            ...
            finetuned_model (bool): Whether the model is a finetuned version.
            distribute_requests (bool): Whether to distribute requests across regions.
            cache_name (str | None): The name of the cache to use.
